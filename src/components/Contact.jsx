            ...
            <div className='flex justify-center items-center'>
                <ul className='space-y-4'>
                    <li className='flex items-center'>
                        ...
                        <p className='text-xl'>+6212 3412 3412</p>
                    </li>
                    <li className='flex items-center'>
                        <Image src={mail} alt="mail" className='h-[110px] w-auto mr-6'/>
                        <p className='text-xl'>aaa@gmail.com</p>
                    </li>
                </ul>

            </div>

            <div className='bg-white/10 p-6 rounded-xl w-full max-w-[550px] mx-auto flex flex-col items-center'>
